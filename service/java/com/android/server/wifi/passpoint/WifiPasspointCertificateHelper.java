 ...
 * certificates.
 */
class WifiPasspointCertificateHelper {
    private static final String TAG = "PasspointCertificateHelper";
    private static final String TAG2 = "PasspointCertificateHelperAdvance";
    private static final String PKEY_MAP_KEY = "HS20_PKEY_MAP_";

    private static WifiPasspointCertificateHelper instance;

    private WifiPasspointCertificateHelper() {
    }

    public static WifiPasspointCertificateHelper getInstance() {
        if (instance == null) {
            instance = new WifiPasspointCertificateHelper();
        }
    ...
    boolean savePkeyMap(Map<String, byte[]> map, String alias) {
        ...
        if (!android.security.KeyStore.getInstance().put(PKEY_MAP_KEY + alias, bytes,
